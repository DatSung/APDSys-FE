...
const Button = ({variant, type, label, onClick, loading, disabled}: IProps) => {
    ...
    const dangerClasses = ' text-white bg-[#AE899A] border-[#AE899A]';
    const lightClasses = ' text-[#754eb4] border-[#754eb4] hover:shadow-[0_0_5px_5px_#754eb44c]';

    const classNameCreator = (): string => {
        let finalClassName = 'flex justify-center items-center outline-none duration-300 h-10 text-lg font-semibold px-6 rounded-2xl border-2';
