...
import {PATH_PUBLIC, PATH_DASHBOARD} from "../../routes/paths.ts";
        ...
        <div className='flex justify-between items-center bg-[#f0ecf7] h-12 px-4'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <div className='flex gap-1'>
                    ...
                    <h1
                        className='px-1 border border-dashed border-purple-300'
                    >
                    ...
                    <h1
                        className='px-1 border border-dashed border-purple-300 rounded-lg flex items-center gap-1'
                    >
                    ...
                    <h1
                        className='px-1 border border-dashed border-purple-300 rounded-lg'
                    >
