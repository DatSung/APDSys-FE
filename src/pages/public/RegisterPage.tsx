...
import {IRegisterDTO} from "../../types/auth.types.ts";
        ...
        <div className='pageTemplate1'>
            ...
            <div
                ...
                <div
                    ...
                    <h1 className='text-6xl font-bold text-[#754eb4]'>DatSung</h1>
            ...
            <form
                ...
                className='flex-1 min-h-[600px] h-4/5 bg-[#f0ecf7] flex flex-col justify-center items-center rounded-l-2xl'
            >
